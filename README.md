...
[![Build Status](https://travis-ci.org/jellevandehaterd/nginx.svg?branch=master)](https://travis-ci.org/jellevandehaterd/nginx)
...
This role was created in 2016 by Jelle van de Haterd and heavily inspired by [Jeff Geerling](http://www.jeffgeerling.com/), author of [geerlingguy.nginx](https://galaxy.ansible.com/geerlingguy/nginx/).